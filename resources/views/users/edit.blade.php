                ...
                <option>Select Department</option>
                 <!-- @foreach ($departments as $department) -->
                  <?php foreach ($departments as $key => $department) { 
                    $selected = ($department->id == $user->department_id) ? 'selected' : '';
                 ?>
                  <option value="{{ $department->id }}" <?php echo $selected;?>>{{ $department->name }}</option>
                <?php } ?>
                 <!-- @endforeach -->
            </select>
         </div> 
         ...
         <div class="intro-y g-col-12 g-col-sm-3">
            ...
            <div class="input-group w-100 mx-auto">
                <div id="input-group-email" class="input-group-text"> <i data-feather="calendar"
                    ...
                    data-single-mode="true" name="dob" value="{{$user->dob}}">
            </div>
        </div>
        <div class="intro-y g-col-12 g-col-sm-3">
             ...
             <div class="d-flex justify-content-start align-items-center">
                <div class="mt-2">
                    <div class="form-check form-switch"> 
                        <input id="checkbox-switch-7"class="form-check-input" type="checkbox" name="active" <?php echo ($user->active == 1) ? 'checked' : ''; ?>> 
