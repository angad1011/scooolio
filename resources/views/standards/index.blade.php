...
<div class="w-full w-sm-auto d-flex mt-4 mt-sm-0">
    <a class="d-flex align-items-center me-3" href="{{ route('standards.create') }}"> 
             ...
             <tbody>
                 @foreach ($standards as $standard)   
                  <tr class="intro-x">
                    ...
                    <td>
                        @php 
                        $active = ($standard->active == 1) ? 'checked' : '';
                        @endphp
                     ...
                     <td class="table-report__action w-56">
                        <div class="d-flex justify-content-start align-items-center">
                            <a class="d-flex align-items-center me-3" href="{{ route('standards.edit',$standard->id) }}"> 
