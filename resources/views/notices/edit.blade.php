...
<a href="{{ route('notices.index') }}" class="btn btn-primary shadow-md me-2">Notice List</a>
 ...
 <div class="intro-y box py-10 mt-5">
   <form method="POST" action="{{ route('notices.update', ['notice' => $notice->id]) }}" enctype="multipart/form-data">
    @csrf
    @method('PUT')
   <div class="px-5">
      <div class="grid columns-12 gap-4 gap-y-5">
         <div class="intro-y g-col-12 g-col-sm-12">
             ...
             <input id="title" type="text" name="title" class="form-control" placeholder="Title" value="{{$notice->title}}" required>
         </div>  
         <div class="intro-y g-col-12 g-col-sm-12">
             <label for="title" class="form-label">Message</label>
            <textarea id="message" name="message" class="form-control" required>{{$notice->message}}</textarea>
         </div>
         ...
         <div class="intro-y g-col-12 g-col-sm-4">
              ...
              <div class="input-group w-100 mx-auto">
                  ...
                  <input type="text" class="datepicker form-control" data-single-mode="true" name="start_date" value="{{$notice->start_date}}">
              </div>
          </div>
          ...
          <div class="intro-y g-col-12 g-col-sm-4">
              ...
              <div class="input-group w-100 mx-auto">
                  <div id="input-group-email" class="input-group-text"> <i data-feather="calendar" class="w-4 h-4"></i> </div> 
                  <input type="text" class="datepicker form-control" data-single-mode="true" name="end_date" value="{{$notice->end_date}}">
              </div>
          </div>
