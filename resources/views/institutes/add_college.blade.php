...
<a href="{{ route('colleges') }}" class="btn btn-primary shadow-md me-2">College List</a>
</div>
</div>
<div class="intro-y box py-10 mt-5">
<form method="POST" action="{{route('college_store')}}" enctype="multipart/form-data">	
  @csrf	
<div class="px-5">
...
<div class="intro-y g-col-12 g-col-sm-4">
<label for="schoolcode" class="form-label">College Code</label>
...
<div class="intro-y g-col-12 g-col-sm-4">
<label for="board" class="form-label">College Board</label>
