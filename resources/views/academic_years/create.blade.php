...
<h2 class="fs-lg fw-medium me-auto">Add New Academic Year</h2>
<div class="w-full w-sm-auto d-flex mt-4 mt-sm-0">
<a href="{{ route('academic_years.index') }}" class="btn btn-primary shadow-md me-2">Academic Year List</a>
</div>
</div>
 <div class="intro-y box py-10 mt-5">
   <form method="POST" action="{{route('academic_years.store')}}" enctype="multipart/form-data">
    @csrf
   <div class="px-5">
      <div class="grid columns-12 gap-4 gap-y-5">
         ...
         <input id="institute_id" type="hidden" name="institute_id" class="form-control" value="{{$instituteId}}">
             ...
             <input id="year" type="text" name="year" class="form-control" placeholder="Academic Year" required>
         </div> 
             ...
             <div class="d-flex justify-content-start align-items-center">
                <div class="mt-2">
                    <div class="form-check form-switch"> 
                        <input id="checkbox-switch-7"class="form-check-input" type="checkbox" name="its_current_year"> 
