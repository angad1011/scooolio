...
<a href="{{ route('divisions.index') }}" class="btn btn-primary shadow-md me-2">Division List</a>
</div>
</div>
 <div class="intro-y box py-10 mt-5">
   <form method="POST" action="{{ route('divisions.update', ['division' => $division->id]) }}" enctype="multipart/form-data">
    @csrf
    @method('PUT')
   <div class="px-5 px-sm-20">
      <div class="grid columns-12 gap-4 gap-y-5">
         <div class="intro-y g-col-12 g-col-sm-6">
             ...
             <input id="name" type="text" name="name" class="form-control" placeholder="Division Name" value="{{ $division->name }}" required>
         </div> 
         <div class="intro-y g-col-12 g-col-sm-6">
             ...
             <div class="d-flex justify-content-start align-items-center">
                <div class="mt-2">
                    <div class="form-check form-switch"> 
                        <input id="checkbox-switch-7"class="form-check-input" type="checkbox" name="active" <?php echo ($division->active == 1) ? 'checked' : ''; ?>> 
